...
public class LocalLdapServer {
    ...
    public void start() throws Exception {
        ...
        // --- Users in the system ---
        addEntry("ou=Members,dc=test", entry -> {
            entry.add("objectClass", "organizationalUnit");
            entry.add("ou", "Members");
        });

        addEntry("uid=tester,ou=Members,dc=test", entry -> {
            entry.add("objectClass", "top", "inetOrgPerson", "organizationalPerson", "person");
        ...
        addIndex((JdbmPartition) partition, "objectClass", "ou", "cn", "uid", "memberObject");
